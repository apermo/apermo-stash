		...
		register_post_type(
			...
			[
				'labels'             => [
					...
					'new_item'           => __( 'New Bookmark', 'apermo-stash' ),
					'view_item'          => __( 'View Bookmark', 'apermo-stash' ),
					'search_items'       => __( 'Search Bookmarks', 'apermo-stash' ),
					'not_found'          => __( 'No bookmarks found.', 'apermo-stash' ),
					'not_found_in_trash' => __( 'No bookmarks found in Trash.', 'apermo-stash' ),
					'all_items'          => __( 'All Bookmarks', 'apermo-stash' ),
				],
				'public'             => false,
